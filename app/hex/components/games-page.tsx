    ...
    <div className="container py-4 sm:py-8 px-4 sm:px-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4">
        ...
        <div className="flex items-center gap-2 text-cosmic-muted text-sm">
          ...
          <span>{games.filter((game) => game.status === "Live").length} Game Available</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <CardHeader className="px-4 sm:px-6 pb-2 sm:pb-4">
              <div className="flex justify-between items-center">
                <CardTitle className="text-cosmic-text text-lg">{game.title}</CardTitle>
                <div
              ...
              <CardDescription className="text-cosmic-muted text-sm">{game.description}</CardDescription>
            </CardHeader>
        ...
        <Card className="overflow-hidden border border-cosmic-accent/20 bg-cosmic-card/50 backdrop-blur-sm opacity-70">
          ...
          <CardHeader className="px-4 sm:px-6 pb-2 sm:pb-4">
            <div className="flex justify-between items-center">
              <CardTitle className="text-cosmic-text text-lg">Mystery Game</CardTitle>
              <div className="px-2 py-1 rounded-full text-xs bg-cosmic-secondary/20 text-cosmic-secondary">
                Coming Soon
              </div>
            </div>
            <CardDescription className="text-cosmic-muted text-sm">A new exciting game is coming soon</CardDescription>
          </CardHeader>
          <CardFooter className="px-4 sm:px-6 pt-0 pb-4 sm:pb-6">
            <Button
